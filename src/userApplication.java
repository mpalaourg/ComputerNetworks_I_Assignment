...
public class userApplication {
	static String echo_request_code = "E0555\r";
	static String image_free_request_code = "M9023\r";
	static String image_error_request_code = "G1334\r";
	static String gps_request_code = "P3279"; 
	static String ACK_request_code = "Q1212\r";
	static String NACK_request_code = "R6533\r";
...
// Initialize the modem and read the intoductory message
	...
	public static boolean check_for_arq(String text) {
		 ...
		 * Find the sequense of the encrypted bytes and for every consecutively character find the XOR value.
		 * Finally, find the FCS value of the input string and check the pairing.
		 */
		String sequense;
		int FCS;

		sequense = text.substring(text.indexOf("<") + 1, text.indexOf(">"));
		int prev_c;
		int curr_c;
		prev_c = (int) sequense.charAt(0);
		for (int i = 1; i < sequense.length(); i++) {
			curr_c = (int) sequense.charAt(i);
